...
$(function () {
  $('.header__nav-button').on('click', function () {
    $('.header__nav-ul').toggleClass('menu-active');
  });
});
const prev = document.querySelector('.basic__right-prev');
const next = document.querySelector('.basic__right-next');
const sliderBox = document.querySelector('.basic__right-box');
const text = document.querySelector('.basic__left-info');
let i = 0;
next.addEventListener('click', function () {
  ...
  if (i > 2) {
    ...
    k = 400 * i;
    sliderBox.style = `transform: translateX(-${k}px)`;

    if (i == 1) {
      text.innerHTML = 'Latest CONVERSE news';
    } else if (i == 2) {
      text.innerHTML = 'Latest NIKE news';
    }
  }
});
prev.addEventListener('click', function () {
  ...
  if (i < 0) {
    ...
    if (i == 1) {
      ...
      text.innerHTML = 'Latest VANS news';
    }
  }
});
const imgBox = document.querySelector('.measure__box-imgbox');
const measureImg1 = document.querySelector('.measure__img1');
const measureImg2 = document.querySelector('.measure__img2');
const measureImg3 = document.querySelector('.measure__img3');
const measureImg4 = document.querySelector('.measure__img4');
const measureImg5 = document.querySelector('.measure__img5');
const measureImg6 = document.querySelector('.measure__img6');
const measureImg7 = document.querySelector('.measure__img7');
const measureImg8 = document.querySelector('.measure__img8');
const summer = document.querySelector('.measure__box-button-1');
const winter = document.querySelector('.measure__box-button-2');
summer.addEventListener('click', function () {
  winter.classList.remove('measure__box-button-active');
  summer.classList.add('measure__box-button-active');
  imgBox.classList.add('measure__box-imgbox-active');
});
winter.addEventListener('click', function () {
  summer.classList.remove('measure__box-button-active');
  winter.classList.add('measure__box-button-active');
  imgBox.classList.remove('measure__box-imgbox-active');
});
const differBtn1 = document.querySelector('.measure__box-differ-btn1');
const differBtn2 = document.querySelector('.measure__box-differ-btn2');
const differBtn3 = document.querySelector('.measure__box-differ-btn3');
const differBtn4 = document.querySelector('.measure__box-differ-btn4');
differBtn1.addEventListener('click', function () {
  differBtn2.classList.remove('measure__box-differ-active');
  differBtn3.classList.remove('measure__box-differ-active');
  differBtn4.classList.remove('measure__box-differ-active');
  differBtn1.classList.add('measure__box-differ-active');
  measureImg1.classList.add('measure__active-1');
  measureImg2.classList.remove('measure__active-1');
  measureImg3.classList.remove('measure__active-1');
  measureImg4.classList.remove('measure__active-1');
  measureImg5.classList.add('measure__active-2');
  measureImg6.classList.remove('measure__active-2');
  measureImg7.classList.remove('measure__active-2');
  measureImg8.classList.remove('measure__active-2');
});
differBtn2.addEventListener('click', function () {
  differBtn3.classList.remove('measure__box-differ-active');
  differBtn4.classList.remove('measure__box-differ-active');
  differBtn1.classList.remove('measure__box-differ-active');
  differBtn2.classList.add('measure__box-differ-active');
  measureImg2.classList.add('measure__active-1');
  measureImg1.classList.remove('measure__active-1');
  measureImg3.classList.remove('measure__active-1');
  measureImg4.classList.remove('measure__active-1');
  measureImg6.classList.add('measure__active-2');
  measureImg5.classList.remove('measure__active-2');
  measureImg7.classList.remove('measure__active-2');
  measureImg8.classList.remove('measure__active-2');
});
differBtn3.addEventListener('click', function () {
  differBtn4.classList.remove('measure__box-differ-active');
  differBtn1.classList.remove('measure__box-differ-active');
  differBtn2.classList.remove('measure__box-differ-active');
  differBtn3.classList.add('measure__box-differ-active');
  measureImg3.classList.add('measure__active-1');
  measureImg2.classList.remove('measure__active-1');
  measureImg1.classList.remove('measure__active-1');
  measureImg4.classList.remove('measure__active-1');
  measureImg7.classList.add('measure__active-2');
  measureImg6.classList.remove('measure__active-2');
  measureImg5.classList.remove('measure__active-2');
  measureImg8.classList.remove('measure__active-2');
});
differBtn4.addEventListener('click', function () {
  differBtn1.classList.remove('measure__box-differ-active');
  differBtn2.classList.remove('measure__box-differ-active');
  differBtn3.classList.remove('measure__box-differ-active');
  differBtn4.classList.add('measure__box-differ-active');
  measureImg4.classList.add('measure__active-1');
  measureImg2.classList.remove('measure__active-1');
  measureImg3.classList.remove('measure__active-1');
  measureImg1.classList.remove('measure__active-1');
  measureImg8.classList.add('measure__active-2');
  measureImg6.classList.remove('measure__active-2');
  measureImg7.classList.remove('measure__active-2');
  measureImg5.classList.remove('measure__active-2');
});
const color = document.querySelector('.measure__box-outcolor');
const range = document.querySelector('.measure__box-incolor');

function axaxaxax() {
  if (color.innerHTML == 1) {
    color.innerHTML = 'red';
  } else if (color.innerHTML == 2) {
    color.innerHTML = 'blue';
  } else if (color.innerHTML == 3) {
    color.innerHTML = 'blueviolet';
  } else if (color.innerHTML == 4) {
    color.innerHTML = 'green';
  } else if (color.innerHTML == 5) {
    color.innerHTML = 'grey';
  }

  setTimeout(() => axaxaxax(), 1);
}

axaxaxax();

function parallax(event) {
  this.querySelectorAll('.end__background').forEach(layer => {
    let dataTest = layer.getAttribute('data-test');
    layer.style.transform = `translateX(${event.clientX * dataTest / 1000}px) translateY(${event.clientY * dataTest / 1000}px)`;
  });
}
